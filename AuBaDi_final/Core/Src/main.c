...
char recipe_1[] = { 30000, 20000, 40000, 10000, 20000 };

volatile int jedz_na;
volatile int lej;
/* USER CODE END PV */
...
//void pour(int time, int position) {
//    flag_busy = 1;
//    time_pour = time;
//    switch (position) {
//
...
//                  lcd16x2_i2c_clear();
//                  lcd16x2_i2c_1stLine();
//                  lcd16x2_i2c_printf(" Wykonuje zadanie");
//                  lcd16x2_i2c_2ndLine();
//                  lcd16x2_i2c_printf("PROSZE CZEKAC");
//                  audio_flag = 4;
//                  recipe = 0;
//                  confirm = 0;
//                  break;
